  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
        <div>
          <label htmlFor="task-title" style={{ display: 'block', fontSize: '13px', marginBottom: '4px', color: '#4a5568' }}>
        ...
        <div>
          <label htmlFor="task-assignee" style={{ display: 'block', fontSize: '13px', marginBottom: '4px', color: '#4a5568' }}>
        ...
        <div>
          <label htmlFor="task-priority" style={{ display: 'block', fontSize: '13px', marginBottom: '4px', color: '#4a5568' }}>
            優先度
          </label>
          <select
            id="task-priority"
        ...
        <div>
          <label htmlFor="task-due" style={{ display: 'block', fontSize: '13px', marginBottom: '4px', color: '#4a5568' }}>
        ...
        <div style={{ gridColumn: '1 / -1' }}>
          <label htmlFor="task-desc" style={{ display: 'block', fontSize: '13px', marginBottom: '4px', color: '#4a5568' }}>
            説明
          </label>
          <textarea
            id="task-desc"
